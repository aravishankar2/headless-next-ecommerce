...
export default function Shop({
  ...
  return (
    <div onClick={() => console.log(allProducts)} className="container">
      ...
      <div className="container d-flex justify-content-center w-100">{limit < allProducts.length && (<button onClick={() => setLimit(prev => prev + 6)} className="btn btn-primary">Load More</button>)}</div>
    </div>
  );
}
